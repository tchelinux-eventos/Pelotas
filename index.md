...
### Banco de Dados: Elaborando soluções de qualidade para o seu projeto

Alguns erros mais comuns vistos em projetos que utilizam banco de dados, são os famosos "Null Pointers" e valores inesperados. Através dessa palestra, será elaborada uma base de dados na qual será utilizada como modelo, logo serão demonstradas boas práticas e algumas funções pouco vistas para que seja possível elaborar soluções de qualidade em projetos que utilizam integração com base de dados.
